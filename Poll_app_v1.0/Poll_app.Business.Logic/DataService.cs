...
namespace Poll_app.Business.Logic
{
    public class DataService
    {
        ...
        public void GenerateReport(List<Question> loadedQuestions)
        {
            if (loadedQuestions is null)
            {
                throw new ArgumentNullException(nameof(loadedQuestions));
        ...
        public void SaveReportToFile(List<Question>loadedQuestions)
        {
            ...
            try
            {
                ostrm = new FileStream(input, FileMode.OpenOrCreate, FileAccess.Write);
            ...
            GenerateReport(loadedQuestions);
